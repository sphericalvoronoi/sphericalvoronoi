...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default="../GlossySynthetic", help="path to the GlossyBlender dataset")
    parser.add_argument('--scene', type=str, default="angel", help="scene name")
