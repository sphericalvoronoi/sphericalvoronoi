...
def load_test_data(
    ...
    if data_path is None:
        data_path = os.path.join(os.path.dirname(__file__), r"./assets/test_garden.npz")
    ...
    betas = torch.rand((N,), device=device) * 10

    return means, quats, scales, opacities, betas, colors, viewmats, Ks, width, height
